...
export type Moment = { id: string; authorId: string; text: string; placeId: string | null; subplace: string; createdAt: string; updatedAt: string; media: Media[] };
...
export type AuthResult = { user: Member; recoveryCode?: string };
