...
export type Moment = { id: string; authorId: string; text: string; placeId: string | null; subplace: string; createdAt: string; recordedAt?: string; updatedAt: string; media: Media[]; visibility?: MomentVisibility };
